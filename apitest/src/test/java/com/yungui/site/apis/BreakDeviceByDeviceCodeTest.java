 ...
 *
 */
public class BreakDeviceByDeviceCodeTest {
	private static Logger logger = LogManager.getLogger();
	
	@Test(dataProvider="breakDeviceByDeviceCodeTestData",dataProviderClass=ApiData.class)
	public void testBreakDeviceByDeviceCode(String deviceCode,String statusVersion) {
		String interfaceName = "com.yung.device.dubbo.DeviceDubboService";
		String methodName = "breakDeviceByDeviceCode" ;
