 ...
 *
 */
public class GetSiteSetBySiteIdTest {
	private static Logger logger = LogManager.getLogger();
	
	@Test(dataProvider="getSiteSetBySiteIdTestData",dataProviderClass=ApiData.class)
	public void testGetSiteSetBySiteId(String siteId) {
		String interfaceName = "com.yung.device.dubbo.DeviceDubboService";
		String methodName = "getSiteSetBySiteId" ;
