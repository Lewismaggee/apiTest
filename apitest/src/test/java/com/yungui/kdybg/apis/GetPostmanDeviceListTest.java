 ...
 *
 */
public class GetPostmanDeviceListTest {
	private static Logger logger = LogManager.getLogger();
	
	@Test(dataProvider="getPostmanDeviceListTestData",dataProviderClass=ApiData.class)
	public void testGetPostmanDeviceList(String startRow,String pageSize,String deviceno,String devicecode,String devicename,String regions
		...
		String methodName = "getPostmanDeviceList" ;
